      ...
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li>
              <a class="nav-link scrollto" href="community.html">ì»¤ë®¤ëí°</a>
            </li>
            <li>
              <a class="nav-link scrollto" href="notices.html">ê³µì§ì¬í­</a>
            </li>
            <li>
              <a class="nav-link scrollto" href="mypage.html">ë§ì´íì´ì§</a>
            </li>
            <li>
              <a class="nav-link scrollto" href="signin.html">ë¡ê·¸ì¸</a>
            </li>
          </ul>
